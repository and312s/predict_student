...
encoder_Marital_status = joblib.load("predict_student/tree/main/model/encoder_Marital_status.joblib")
encoder_Application_mode = joblib.load("predict_student/tree/main/model/encoder_Application_mode.joblib")
encoder_Previous_qualification = joblib.load("predict_student/tree/main/model/encoder_Previous_qualification.joblib")
encoder_Displaced	= joblib.load("predict_student/tree/main/model/encoder_Displaced.joblib")
encoder_Debtor = joblib.load("predict_student/tree/main/model/encoder_Debtor.joblib")
encoder_Tuition_fees_up_to_date	= joblib.load("predict_student/tree/main/model/encoder_Tuition_fees_up_to_date.joblib")
encoder_Gender = joblib.load("predict_student/tree/main/model/encoder_Gender.joblib")
encoder_Scholarship_holder = joblib.load("predict_student/tree/main/model/encoder_Scholarship_holder.joblib")
scaler_Age_at_enrollment = joblib.load("predict_student/tree/main/model/scaler_Age_at_enrollment.joblib")
scaler_Admission_grade = joblib.load("predict_student/tree/main/model/scaler_Admission_grade.joblib")
scaler_Age_at_enrollment = joblib.load("predict_student/tree/main/model/scaler_Age_at_enrollment.joblib")
scaler_Curricular_units_1st_sem_approved = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_1st_sem_approved.joblib")
scaler_Curricular_units_1st_sem_enrolled = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_1st_sem_enrolled.joblib")
scaler_Curricular_units_1st_sem_evaluations = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_1st_sem_evaluations.joblib")
scaler_Curricular_units_1st_sem_grade = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_1st_sem_grade.joblib")
scaler_Curricular_units_1st_sem_without_evaluations = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_1st_sem_without_evaluations.joblib")
scaler_Curricular_units_2nd_sem_approved = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_2nd_sem_approved.joblib")
scaler_Curricular_units_2nd_sem_enrolled = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_2nd_sem_enrolled.joblib")
scaler_Curricular_units_2nd_sem_evaluations = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_2nd_sem_evaluations.joblib")
scaler_Curricular_units_2nd_sem_grade = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_2nd_sem_grade.joblib")
scaler_Curricular_units_2nd_sem_without_evaluations = joblib.load("predict_student/tree/main/model/scaler_Curricular_units_2nd_sem_without_evaluations.joblib")
